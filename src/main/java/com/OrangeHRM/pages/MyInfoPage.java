...
import com.OrangeHRM.PageItem.EditEmployeeConstants.ContactDetails;
import com.OrangeHRM.PageItem.EditEmployeeConstants.JobDetails;
import com.OrangeHRM.PageItem.EditEmployeeConstants.PersonalDetails;
import com.OrangeHRM.PageItem.EditEmployeeConstants.ReportTo;
...
public class MyInfoPage extends LoadableComponent<MyInfoPage>{
	...
	public void slectDropdownByLabel(WebDriver driver, String txtLabel, String optValue) {
		...
		Log.assertThat(found, txtLabel +": "+optValue+ " selected", txtLabel +": "+ "Failed to select "+optValue, driver);	
	...
	public void enterDataOnTextField(WebDriver driver, String txtLabel, String optionValue ) {
		...
		Log.messageStep(txtLabel +": "+optionValue+ " selected", driver);
	}
	 ...
	 */
	public ArrayList<String> addEmployeeJobDetails(WebDriver driver, OrangeHRMDataEngine testData) {
		...
		enterJoinedDate(driver, JobDetails.JOINED_DATE, EmployeeJobDetails.builder()
				.joinedDate(testData.getCurrentDate())
				.build());
