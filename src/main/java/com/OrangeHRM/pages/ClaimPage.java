...
import com.OrangeHRM.PageItem.ClaimConstants.AddExpense;
import com.OrangeHRM.PageItem.ClaimConstants.CreateClaimRequest;
import com.OrangeHRM.PageItem.ClaimConstants.NavName;
...
public class ClaimPage extends LoadableComponent<ClaimPage>{
	 ...
	 * @return ClaimPage
	 */
	public ClaimPage createNewClaimRequest(WebDriver driver) {
	...
	public ClaimPage enterDate(WebDriver driver, AddExpense date, ExpenseDetails expenseDetails) {
		MyInfoPage myInfoPage = new MyInfoPage(driver);
		myInfoPage.enterDataOnTextField(driver, date.getName(), expenseDetails.getDate() );
		return this;
	}
	...
	public ClaimPage verifyTotalAmount(WebDriver driver, String currency, String amount) {
		...
		Log.assertThat(expText.equals(txtTotalAmt), "Successfully verified expense amount", "Failed to veriyfy expense amount");
		return this;
	}
