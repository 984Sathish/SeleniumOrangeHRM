...
import com.OrangeHRM.PageItem.DashboardConstants.menuName;
...
public class DashboardPage extends LoadableComponent<DashboardPage>{
	...
	@IFindBy(how = How.CSS, using = "p[class*='orangehrm-copyright']", AI = false)
	...
	protected void isLoaded() throws Error {
		...
		if(isPageLoaded && !(BrowserActions.waitForElementToDisplay(driver,footer))) {
	...
	public LoginPage logOut(WebDriver driver) {
		...
		Log.messageStep("Logout to application", driver);
