...
import com.OrangeHRM.PageItem.AdminConstants.AddUser;
import com.OrangeHRM.PageItem.OrangeHRMData.EnterEmpFullName;
import com.OrangeHRM.PageItem.OrangeHRMData.UserDetails;
import com.OrangeHRM.PageItem.PimConstants.EmployeeInfo;
import com.OrangeHRM.PageItem.PimConstants.NavName;
...
public class PimPage extends LoadableComponent<PimPage>{
	...
	private ArrayList<String> lstEmployeesInfo = new ArrayList<String>();
	...
	public void VerifyTableAndDelete(WebDriver driver, String value) throws InterruptedException {
		...
		if(rowSize == 1 && (BrowserActions.waitForElementToDisplay(driver, txtSearchResult))){
			...
			Log.assertThat(equal, "Given Details is verified successfully", "Failed to verify the given details", driver);
			if(equal) {
				BrowserActions.click(driver, btnIconDelete, "Delete icon");
				BrowserActions.click(driver, btnYesDelete, "Yes, Delete");
				Log.messageStep(value + " Deleted successfully", driver);
			}
