...
import com.OrangeHRM.PageItem.DashboardConstants;
...
import com.OrangeHRM.PageItem.PimConstants;
import com.OrangeHRM.PageItem.PimConstants.PIMTabs;
...
public class EmployeeTestSuite {
	...
	public void TC007() throws Exception {
		...
		try {
			...
			employeeJobDetails = myInfoPage.addEmployeeJobDetails(driver, testData);
